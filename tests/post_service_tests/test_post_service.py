...
class PostServiceTestCase(unittest.TestCase):
    ...
    def test_update_post_success(self):
        ...
        update_response = self.client.put(
            f"/posts/{post_id}",
            data=json.dumps(
                {"text_content": "Updated content", "content_type": "edited_text"}
            ),
            content_type="application/json",
        )
    ...
    def test_delete_post_success(self):
        ...
        self.assertIn(
            "Post deleted successfully", delete_response.get_data(as_text=True)
        )
    ...
    def test_get_posts_by_user(self):
        ...
        self.assertEqual(
            data[0]["text_content"], "User 1 Post 2"
        )  # Ordered by desc created_at
    ...
    def test_get_feed_basic(self):
        ...
        self._create_post(self.test_user_id, "Feed Post 1", created_at=ts1.isoformat())
        self._create_post(
            self.test_user_id + 1, "Feed Post 2", created_at=ts2.isoformat()
        )
